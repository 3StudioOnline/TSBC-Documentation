...
The `Secp256k1` elliptic curve is defined over the finite field of prime order. The equation of the curve is: `y2 = x3 + 7 mod p`.

where:
* p is a large prime number (the field modulus),
* x andy are the coordinates of a point on the curve.
...
In this page you will find all the available functions for `Secp256k1` curve implemented in this plugin.
...
* <Step text="1"/> The generated private key.
* <Step text="2"/> A boolean value indicating whether the private key generation was successful or not.
...
* <Step text="1"/> The private key to use for generating the public key.

The function returns the following:
* <Step text="2"/> The generated public key.
* <Step text="3"/> A boolean value indicating whether the public key generation was successful or not.
...
This function requires the following inputs:
* <Step text="1"/> The private key to validate.

The function returns the following:
* <Step text="2"/>  A boolean value indicating whether the given private key is valid for Secp256k1 or not.
...
This function requires the following inputs:
* <Step text="1"/> The public key to validate.

The function returns the following:
* <Step text="2"/>  A boolean value indicating whether the given public key is valid for Secp256k1 or not.
...
This function requires the following inputs:
* <Step text="1"/> The public key to use for generating the secret.
* <Step text="2"/> The private key to use for generating the secret.

The function returns the following:
* <Step text="3"/>  The generated secret.
* <Step text="4"/>  A boolean value indicating whether the shared secret generation using Secp256k1 was successful or not.
...
This function requires the following inputs:
* <Step text="1"/> The private key to use for signing.
* <Step text="2"/> The hash sign.

The function returns the following:
* <Step text="3"/>  The created signature.
* <Step text="4"/>  A boolean value indicating whether the signing using Secp256k1 was successful or not.
...
* <Step text="1"/> The private key to use for signing.
* <Step text="2"/> The hash sign.
* <Step text="3"/> Type of the hash function used in hashing the message.
...
The function returns the following:
* <Step text="4"/>  The created signature.
* <Step text="5"/>  A boolean value indicating whether the deterministic signing using Secp256k1 was successful or not.
...
This function requires the following inputs:
* <Step text="1"/> The public key to verify.
* <Step text="2"/> The signed hash to verify.
* <Step text="3"/> The signature to verify.

The function returns the following:
* <Step text="4"/>  A boolean value indicating whether the signature of a signed hash using Secp256k1 is valid or not.
...
This function requires the following inputs:
* <Step text="1"/> The uncompressed public key.

The function returns the following:
* <Step text="2"/> The compressed public key.
* <Step text="3"/>  A boolean value indicating whether the compression of the public key using Secp256k1 was successful or not.
...
This function requires the following inputs:
* <Step text="1"/> The compressed public key.

The function returns the following:
* <Step text="2"/> The uncompressed public key.
* <Step text="3"/>  A boolean value indicating whether the decompression of the public key using Secp256k1 was successful or not.
